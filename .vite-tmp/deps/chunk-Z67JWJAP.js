...
var _ResizePlugin = class _ResizePlugin {
  /**
...
__name(_TickerPlugin, "TickerPlugin");
var TickerPlugin = _TickerPlugin;
...
var convertToList = /* @__PURE__ */ __name((input, transform, forceTransform = false) => {
...
var _Resolver = class _Resolver {
  constructor() {
    this._defaultBundleIdentifierOptions = {
      connector: "-",
      createBundleAssetId: /* @__PURE__ */ __name((bundleId, assetId) => `${bundleId}${this._bundleIdConnector}${assetId}`, "createBundleAssetId"),
      extractAssetIdFromBundle: /* @__PURE__ */ __name((bundleId, assetBundleId) => assetBundleId.replace(`${bundleId}${this._bundleIdConnector}`, ""), "extractAssetIdFromBundle")
    };
...
var _Spritesheet = (_a = class {
  ...
  parse() {
    return new Promise((resolve) => {
      ...
      this._batchIndex = 0;
      if (this._frameKeys.length <= _a.BATCH_SIZE) {
  ...
  _nextBatch() {
    ...
    this._batchIndex++;
    setTimeout(() => {
      if (this._batchIndex * _a.BATCH_SIZE < this._frameKeys.length) {
        this._nextBatch();
      } else {
        this._processAnimations();
        this._parseComplete();
...
var spritesheetAsset = {
  ...
  cache: {
    test: /* @__PURE__ */ __name((asset) => asset instanceof Spritesheet, "test"),
    getCacheableAssets: /* @__PURE__ */ __name((keys, asset) => getCacheableAssets(keys, asset, false), "getCacheableAssets")
  },
...
var _AlphaMask = class _AlphaMask {
  constructor(options) {
    this.priority = 0;
    this.inverse = false;
    this.pipe = "alphaMask";
...
__name(_AlphaMask, "AlphaMask");
var AlphaMask = _AlphaMask;
AlphaMask.extension = ExtensionType.MaskEffect;

// node_modules/pixi.js/lib/rendering/mask/color/ColorMask.mjs
var _ColorMask = class _ColorMask {
  constructor(options) {
    this.priority = 0;
    this.pipe = "colorMask";
    if (options?.mask) {
...
__name(_ColorMask, "ColorMask");
var ColorMask = _ColorMask;
ColorMask.extension = ExtensionType.MaskEffect;

// node_modules/pixi.js/lib/rendering/mask/stencil/StencilMask.mjs
var _StencilMask = class _StencilMask {
  constructor(options) {
    this.priority = 0;
...
__name(_StencilMask, "StencilMask");
var StencilMask = _StencilMask;
StencilMask.extension = ExtensionType.MaskEffect;

// node_modules/pixi.js/lib/rendering/renderers/shared/texture/sources/ImageSource.mjs
var _ImageSource = class _ImageSource extends TextureSource {
  constructor(options) {
    super(options);
...
__name(_ImageSource, "ImageSource");
...
var _a2;
var _VideoSource = (_a2 = class extends TextureSource {
  constructor(options) {
    super(options);
    this.isReady = false;
...
var _CacheClass = class _CacheClass {
  constructor() {
    this._parsers = [];
...
var _BatchableGraphics = class _BatchableGraphics {
  constructor() {
...
__name(_BatchableGraphics, "BatchableGraphics");
var BatchableGraphics = _BatchableGraphics;
...
__name(buildPixelLine, "buildPixelLine");
...
var _a3;
var _FillGradient = (_a3 = class {
  constructor(...args) {
    this.uid = uid("fillGradient");
    this.type = "linear";
    this.colorStops = [];
    let options = ensureGradientOptions(args);
    const defaults = options.type === "radial" ? _a3.defaultRadialOptions : _a3.defaultLinearOptions;
...
__name(addColorStops, "addColorStops");
...
__name(ensureGradientOptions, "ensureGradientOptions");
...
__name(generateTextureMatrix, "generateTextureMatrix");
...
var _GpuGraphicsContext = class _GpuGraphicsContext {
  constructor() {
    this.batches = [];
    this.geometryData = {
      vertices: [],
...
__name(_GpuGraphicsContext, "GpuGraphicsContext");
var GpuGraphicsContext = _GpuGraphicsContext;
var _GraphicsContextRenderData = class _GraphicsContextRenderData {
  constructor() {
...
__name(_GraphicsContextRenderData, "GraphicsContextRenderData");
var GraphicsContextRenderData = _GraphicsContextRenderData;
var _a4;
var _GraphicsContextSystem = (_a4 = class {
   ...
   */
  init(options) {
    _a4.defaultOptions.bezierSmoothness = options?.bezierSmoothness ?? _a4.defaultOptions.bezierSmoothness;
  }
  /**
...
}, __name(_a4, "_GraphicsContextSystem"), _a4);
...
var _GraphicsGpuData = class _GraphicsGpuData {
  constructor() {
    this.batches = [];
    this.batched = false;
  }
...
__name(_GraphicsGpuData, "GraphicsGpuData");
var GraphicsGpuData = _GraphicsGpuData;
var _GraphicsPipe = class _GraphicsPipe {
...
__name(_GraphicsPipe, "GraphicsPipe");
var GraphicsPipe = _GraphicsPipe;
...
var _BatchableMesh = class _BatchableMesh {
  constructor() {
    this.batcherName = "default";
    this.packAsQuad = false;
    this.indexOffset = 0;
...
__name(_BatchableMesh, "BatchableMesh");
var BatchableMesh = _BatchableMesh;

// node_modules/pixi.js/lib/scene/mesh/shared/MeshPipe.mjs
var _MeshGpuData = class _MeshGpuData {
  destroy() {
  }
};
__name(_MeshGpuData, "MeshGpuData");
var MeshGpuData = _MeshGpuData;
var _MeshPipe = class _MeshPipe {
  constructor(renderer, adaptor) {
  ...
  _getMeshData(mesh) {
    var _a12, _b;
    (_a12 = mesh._gpuData)[_b = this.renderer.uid] || (_a12[_b] = new MeshGpuData());
...
__name(_MeshPipe, "MeshPipe");
var MeshPipe = _MeshPipe;
MeshPipe.extension = {
  type: [
    ExtensionType.WebGLPipes,
    ExtensionType.WebGPUPipes,
...
var _GlParticleContainerAdaptor = class _GlParticleContainerAdaptor {
...
__name(_GlParticleContainerAdaptor, "GlParticleContainerAdaptor");
var GlParticleContainerAdaptor = _GlParticleContainerAdaptor;
...
__name(createIndicesForQuads, "createIndicesForQuads");
...
__name(generateParticleUpdateFunction, "generateParticleUpdateFunction");
...
__name(generateUpdateFunction, "generateUpdateFunction");

// node_modules/pixi.js/lib/scene/particle-container/shared/ParticleBuffer.mjs
var _ParticleBuffer = class _ParticleBuffer {
  constructor(options) {
    this._size = 0;
...
__name(_ParticleBuffer, "ParticleBuffer");
var ParticleBuffer = _ParticleBuffer;
...
__name(getParticleSyncKey, "getParticleSyncKey");
...
var _ParticleShader = class _ParticleShader extends Shader {
  constructor() {
...
__name(_ParticleShader, "ParticleShader");
var ParticleShader = _ParticleShader;

// node_modules/pixi.js/lib/scene/particle-container/shared/ParticleContainerPipe.mjs
var _ParticleContainerPipe = class _ParticleContainerPipe {
  /**
...
__name(_ParticleContainerPipe, "ParticleContainerPipe");
var ParticleContainerPipe = _ParticleContainerPipe;

// node_modules/pixi.js/lib/scene/particle-container/shared/GlParticleContainerPipe.mjs
var _GlParticleContainerPipe = class _GlParticleContainerPipe extends ParticleContainerPipe {
  constructor(renderer) {
    super(renderer, new GlParticleContainerAdaptor());
  }
};
__name(_GlParticleContainerPipe, "GlParticleContainerPipe");
var GlParticleContainerPipe = _GlParticleContainerPipe;
...
var _GpuParticleContainerAdaptor = class _GpuParticleContainerAdaptor {
  execute(particleContainerPipe, container) {
    const renderer = particleContainerPipe.renderer;
    const shader = container.shader || particleContainerPipe.defaultShader;
...
__name(_GpuParticleContainerAdaptor, "GpuParticleContainerAdaptor");
var GpuParticleContainerAdaptor = _GpuParticleContainerAdaptor;

// node_modules/pixi.js/lib/scene/particle-container/shared/GpuParticleContainerPipe.mjs
var _GpuParticleContainerPipe = class _GpuParticleContainerPipe extends ParticleContainerPipe {
  constructor(renderer) {
    super(renderer, new GpuParticleContainerAdaptor());
  }
};
__name(_GpuParticleContainerPipe, "GpuParticleContainerPipe");
var GpuParticleContainerPipe = _GpuParticleContainerPipe;
...
__name(updateTextBounds, "updateTextBounds");

// node_modules/pixi.js/lib/scene/text/canvas/BatchableText.mjs
var _BatchableText = class _BatchableText extends BatchableSprite {
  constructor(renderer) {
    super();
    this._renderer = renderer;
...
__name(_BatchableText, "BatchableText");
var BatchableText = _BatchableText;

// node_modules/pixi.js/lib/scene/text/canvas/CanvasTextPipe.mjs
var _CanvasTextPipe = class _CanvasTextPipe {
  constructor(renderer) {
    this._renderer = renderer;
  }
...
__name(_CanvasTextPipe, "CanvasTextPipe");
var CanvasTextPipe = _CanvasTextPipe;
...
var _FillPattern = class _FillPattern {
...
__name(_FillPattern, "FillPattern");
var FillPattern = _FillPattern;
...
__name(parseSVGPath, "parseSVGPath");

// node_modules/pixi.js/lib/maths/shapes/Circle.mjs
var _Circle = class _Circle {
  /**
...
var isCornerWithinStroke = /* @__PURE__ */ __name((pX, pY, cornerX, cornerY, radius, strokeWidthInner, strokeWidthOuter) => {
  const dx = pX - cornerX;
  const dy = pY - cornerY;
  const distance = Math.sqrt(dx * dx + dy * dy);
  return distance >= radius - strokeWidthInner && distance <= radius + strokeWidthOuter;
}, "isCornerWithinStroke");
var _RoundedRectangle = class _RoundedRectangle {
  /**
...
__name(_RoundedRectangle, "RoundedRectangle");
...
var _ShapePath = class _ShapePath {
...
__name(_ShapePath, "ShapePath");
var ShapePath = _ShapePath;

// node_modules/pixi.js/lib/scene/graphics/shared/path/GraphicsPath.mjs
var _GraphicsPath = class _GraphicsPath {
  /**
...
__name(_GraphicsPath, "GraphicsPath");
var GraphicsPath = _GraphicsPath;
...
__name(parseSVGFloatAttribute, "parseSVGFloatAttribute");
...
__name(parseSVGDefinitions, "parseSVGDefinitions");
...
__name(extractSvgUrlId, "extractSvgUrlId");
...
__name(parseSVGStyle, "parseSVGStyle");
...
__name(parseAttribute, "parseAttribute");
...
__name(handleTexture, "handleTexture");
...
var _a5;
var _GraphicsContext = (_a5 = class extends eventemitter3_default {
  constructor() {
    super(...arguments);
    ...
    this._fillStyle = { ..._a5.defaultFillStyle };
    this._strokeStyle = { ..._a5.defaultStrokeStyle };
    this._stateStack = [];
    this._tick = 0;
    this._bounds = new Bounds();
  ...
  set fillStyle(value) {
    this._fillStyle = toFillStyle(value, _a5.defaultFillStyle);
  }
  /**
  ...
  set strokeStyle(value) {
    this._strokeStyle = toStrokeStyle(value, _a5.defaultStrokeStyle);
  }
  /**
   ...
   */
  setFillStyle(style) {
    this._fillStyle = toFillStyle(style, _a5.defaultFillStyle);
    return this;
  }
  /**
  ...
  setStrokeStyle(style) {
    this._strokeStyle = toFillStyle(style, _a5.defaultStrokeStyle);
    return this;
  }
  ...
  stroke(style) {
    ...
    if (!path2)
      return this;
    if (style != null) {
      this._strokeStyle = toStrokeStyle(style, _a5.defaultStrokeStyle);
    }
    this.instructions.push({
      action: "stroke",
      // TODO copy fill style!
...
}, __name(_a5, "_GraphicsContext"), _a5);
...
__name(addFiltersKey, "addFiltersKey");
...
var _a6;
var _TextStyle = (_a6 = class extends eventemitter3_default {
  constructor(style = {}) {
    super();
    convertV7Tov8Style(style);
    const fullStyle = { ..._a6.defaultTextStyle, ...style };
  ...
  set dropShadow(value) {
    if (value !== null && typeof value === "object") {
      this._dropShadow = this._createProxy({ ..._a6.defaultDropShadow, ...value });
    } else {
      this._dropShadow = value ? this._createProxy({ ..._a6.defaultDropShadow }) : null;
    }
    this.update();
  }
  ...
  reset() {
    const defaultStyle = _a6.defaultTextStyle;
  ...
  _createProxy(value, cb) {
    return new Proxy(value, {
      set: /* @__PURE__ */ __name((target, property, newValue) => {
...
__name(ensureInternalCanvas, "ensureInternalCanvas");
...
var _a7;
var _CanvasTextMetrics = (_a7 = class {
  /**
  ...
  static get experimentalLetterSpacingSupported() {
    let result = _a7._experimentalLetterSpacingSupported;
    if (result === void 0) {
      const proto = DOMAdapter.get().getCanvasRenderingContext2D().prototype;
      result = _a7._experimentalLetterSpacingSupported = "letterSpacing" in proto || "textLetterSpacing" in proto;
    }
    return result;
  }
  /**
   ...
   */
  static measureText(text = " ", style, canvas = _a7._canvas, wordWrap = style.wordWrap) {
    const font = fontStringFromTextStyle(style);
    const fontProperties = _a7.measureFont(font);
    if (fontProperties.fontSize === 0) {
      fontProperties.fontSize = style.fontSize;
      fontProperties.ascent = style.fontSize;
    }
    const context = _a7.__context;
    context.font = font;
    const outputText = wordWrap ? _a7._wordWrap(text, style, canvas) : text;
    const lines = outputText.split(/(?:\r\n|\r|\n)/);
    const lineWidths = new Array(lines.length);
    let maxLineWidth = 0;
    for (let i = 0; i < lines.length; i++) {
      const lineWidth = _a7._measureText(lines[i], style.letterSpacing, context);
  ...
  static _measureText(text, letterSpacing, context) {
    ...
    if (_a7.experimentalLetterSpacingSupported) {
      if (_a7.experimentalLetterSpacing) {
    ...
    if (metricWidth > 0) {
      if (useExperimentalLetterSpacing) {
        ...
        const val = (_a7.graphemeSegmenter(text).length - 1) * letterSpacing;
        metricWidth += val;
        boundsWidth += val;
      }
    }
   ...
   */
  static _wordWrap(text, style, canvas = _a7._canvas) {
    ...
    const collapseSpaces = _a7._collapseSpaces(whiteSpace);
    const collapseNewlines = _a7._collapseNewlines(whiteSpace);
    let canPrependSpaces = !collapseSpaces;
    const wordWrapWidth = style.wordWrapWidth + letterSpacing;
    const tokens = _a7._tokenize(text);
    for (let i = 0; i < tokens.length; i++) {
      let token = tokens[i];
      if (_a7._isNewline(token)) {
        if (!collapseNewlines) {
          lines += _a7._addLine(line);
      ...
      if (collapseSpaces) {
        const currIsBreakingSpace = _a7.isBreakingSpace(token);
        const lastIsBreakingSpace = _a7.isBreakingSpace(line[line.length - 1]);
        if (currIsBreakingSpace && lastIsBreakingSpace) {
          continue;
        }
      }
      const tokenWidth = _a7._getFromCache(token, letterSpacing, cache, context);
      if (tokenWidth > wordWrapWidth) {
        ...
        if (_a7.canBreakWords(token, style.breakWords)) {
          const characters = _a7.wordWrapSplit(token);
          for (let j = 0; j < characters.length; j++) {
            ...
            while (characters[j + k]) {
              ...
              if (!_a7.canBreakChars(lastChar, nextChar, token, j, style.breakWords)) {
                char += nextChar;
              } else {
                break;
              }
            ...
            j += k - 1;
            const characterWidth = _a7._getFromCache(char, letterSpacing, cache, context);
          ...
          lines += _a7._addLine(token, !isLastToken);
          canPrependSpaces = false;
          line = "";
          width = 0;
        }
        ...
        if (line.length > 0 || !_a7.isBreakingSpace(token) || canPrependSpaces) {
          line += token;
          width += tokenWidth;
        }
      }
    }
    lines += _a7._addLine(line, false);
    return lines;
  }
  /**
...
` : line;
  ...
  static _getFromCache(key, letterSpacing, cache, context) {
    ...
    if (typeof width !== "number") {
      width = _a7._measureText(key, letterSpacing, context) + letterSpacing;
      cache[key] = width;
    }
    return width;
  }
  ...
  static _isNewline(char) {
    ...
    return _a7._newlines.includes(char.charCodeAt(0));
  }
  /**
  ...
  static isBreakingSpace(char, _nextChar) {
    ...
    return _a7._breakingSpaces.includes(char.charCodeAt(0));
  }
  /**
  ...
  static _tokenize(text) {
    ...
    for (let i = 0; i < text.length; i++) {
      ...
      if (_a7.isBreakingSpace(char, nextChar) || _a7._isNewline(char)) {
        if (token !== "") {
          tokens.push(token);
          token = "";
        }
  ...
  static wordWrapSplit(token) {
    return _a7.graphemeSegmenter(token);
  }
  /**
  ...
  static measureFont(font) {
    if (_a7._fonts[font]) {
      return _a7._fonts[font];
    }
    const context = _a7._context;
    context.font = font;
    const metrics = context.measureText(_a7.METRICS_STRING + _a7.BASELINE_SYMBOL);
    const properties = {
      ascent: metrics.actualBoundingBoxAscent,
      descent: metrics.actualBoundingBoxDescent,
      fontSize: metrics.actualBoundingBoxAscent + metrics.actualBoundingBoxDescent
    };
    _a7._fonts[font] = properties;
    return properties;
  }
  /**
  ...
  static get _context() {
    if (!_a7.__context) {
      _a7.__context = _a7._canvas.getContext("2d", contextSettings);
    }
    return _a7.__context;
  }
}, __name(_a7, "_CanvasTextMetrics"), _a7);
...
var _CanvasTextGeneratorClass = class _CanvasTextGeneratorClass {
  /**
...
__name(_CanvasTextGeneratorClass, "CanvasTextGeneratorClass");
var CanvasTextGeneratorClass = _CanvasTextGeneratorClass;
var CanvasTextGenerator = new CanvasTextGeneratorClass();

// node_modules/pixi.js/lib/scene/text/canvas/CanvasTextSystem.mjs
var _CanvasTextSystem = class _CanvasTextSystem {
...
__name(_CanvasTextSystem, "CanvasTextSystem");
var CanvasTextSystem = _CanvasTextSystem;
...
var _Graphics = class _Graphics extends ViewContainer {
  /**
...
var gpuProgram;
var glProgram;
var _SdfShader = class _SdfShader extends Shader {
...
__name(_SdfShader, "SdfShader");
var SdfShader = _SdfShader;

// node_modules/pixi.js/lib/scene/text-bitmap/AbstractBitmapFont.mjs
var _AbstractBitmapFont = class _AbstractBitmapFont extends eventemitter3_default {
  constructor() {
    super(...arguments);
...
__name(_AbstractBitmapFont, "AbstractBitmapFont");
var AbstractBitmapFont = _AbstractBitmapFont;

// node_modules/pixi.js/lib/scene/text-bitmap/DynamicBitmapFont.mjs
var _a8;
var _DynamicBitmapFont = (_a8 = class extends AbstractBitmapFont {
  /**
  ...
  constructor(options) {
    ...
    const dynamicOptions = { ..._a8.defaultOptions, ...options };
...
}, __name(_a8, "_DynamicBitmapFont"), _a8);
...
function getBitmapTextLayout(chars, style, font, trimEnd) {
  ...
  const checkIsOverflow = /* @__PURE__ */ __name((lineWidth) => lineWidth - adjustedLetterSpacing > adjustedWordWrapWidth, "checkIsOverflow");
...
var fontCount = 0;
var _BitmapFontManagerClass = class _BitmapFontManagerClass {
  constructor() {
    this.ALPHA = [["a", "z"], ["A", "Z"], " "];
    this.NUMERIC = [["0", "9"]];
...
__name(_BitmapFontManagerClass, "BitmapFontManagerClass");
var BitmapFontManagerClass = _BitmapFontManagerClass;
var BitmapFontManager = new BitmapFontManagerClass();

// node_modules/pixi.js/lib/scene/text-bitmap/BitmapTextPipe.mjs
var _BitmapTextGraphics = class _BitmapTextGraphics extends Graphics {
  destroy() {
...
__name(_BitmapTextGraphics, "BitmapTextGraphics");
var BitmapTextGraphics = _BitmapTextGraphics;
var _BitmapTextPipe = class _BitmapTextPipe {
  constructor(renderer) {
    this._renderer = renderer;
...
__name(_BitmapTextPipe, "BitmapTextPipe");
var BitmapTextPipe = _BitmapTextPipe;
...
var _BatchableHTMLText = class _BatchableHTMLText extends BatchableSprite {
  /**
...
__name(_BatchableHTMLText, "BatchableHTMLText");
var BatchableHTMLText = _BatchableHTMLText;

// node_modules/pixi.js/lib/scene/text-html/HTMLTextPipe.mjs
var _HTMLTextPipe = class _HTMLTextPipe {
  constructor(renderer) {
    this._renderer = renderer;
  }
...
__name(_HTMLTextPipe, "HTMLTextPipe");
var HTMLTextPipe = _HTMLTextPipe;
...
var _HTMLTextRenderData = class _HTMLTextRenderData {
  constructor() {
...
__name(_HTMLTextRenderData, "HTMLTextRenderData");
var HTMLTextRenderData = _HTMLTextRenderData;
...
var _HTMLTextSystem = class _HTMLTextSystem {
  constructor(renderer) {
    this._renderer = renderer;
...
__name(_HTMLTextSystem, "HTMLTextSystem");
var HTMLTextSystem = _HTMLTextSystem;
...
var _a9;
var _MeshGeometry = (_a9 = class extends Geometry {
  constructor(...args) {
    let options = args[0] ?? {};
...
var gpuProgram2;
var glProgram2;
var _TilingSpriteShader = class _TilingSpriteShader extends Shader {
  constructor() {
...
__name(_TilingSpriteShader, "TilingSpriteShader");
var TilingSpriteShader = _TilingSpriteShader;

// node_modules/pixi.js/lib/scene/sprite-tiling/utils/QuadGeometry.mjs
var _QuadGeometry = class _QuadGeometry extends MeshGeometry {
  constructor() {
    super({
...
__name(_QuadGeometry, "QuadGeometry");
var QuadGeometry = _QuadGeometry;
...
var _TilingSpriteGpuData = class _TilingSpriteGpuData {
  constructor() {
    this.canBatch = true;
...
__name(_TilingSpriteGpuData, "TilingSpriteGpuData");
var TilingSpriteGpuData = _TilingSpriteGpuData;
var _TilingSpritePipe = class _TilingSpritePipe {
  constructor(renderer) {
...
__name(_TilingSpritePipe, "TilingSpritePipe");
var TilingSpritePipe = _TilingSpritePipe;
...
var _a10;
var _PlaneGeometry = (_a10 = class extends MeshGeometry {
  constructor(...args) {
    super({});
    let options = args[0] ?? {};
   ...
   */
  build(options) {
    options = { ..._a10.defaultOptions, ...options };
...
}, __name(_a10, "_PlaneGeometry"), _a10);
...
var _a11;
var _NineSliceGeometry = (_a11 = class extends PlaneGeometry {
  constructor(options = {}) {
    options = { ..._a11.defaultOptions, ...options };
    super({
      width: options.width,
...
}, __name(_a11, "_NineSliceGeometry"), _a11);
...
var _NineSliceSpriteGpuData = class _NineSliceSpriteGpuData extends BatchableMesh {
  constructor() {
    super();
...
__name(_NineSliceSpriteGpuData, "NineSliceSpriteGpuData");
var NineSliceSpriteGpuData = _NineSliceSpriteGpuData;
var _NineSliceSpritePipe = class _NineSliceSpritePipe {
  constructor(renderer) {
    this._renderer = renderer;
  }
...
__name(_NineSliceSpritePipe, "NineSliceSpritePipe");
var NineSliceSpritePipe = _NineSliceSpritePipe;
...
var _FilterData = class _FilterData {
  constructor() {
    this.skip = false;
...
__name(_FilterData, "FilterData");
var FilterData = _FilterData;
var _FilterSystem = class _FilterSystem {
  constructor(renderer) {
...
__name(_FilterSystem, "FilterSystem");
var FilterSystem = _FilterSystem;
...
//# sourceMappingURL=chunk-Z67JWJAP.js.map
