import "./chunk-4PQ5CKFA.js";
import "./chunk-SIVKA2UL.js";
import "./chunk-Z67JWJAP.js";
import "./chunk-CTXNNCQD.js";
import "./chunk-RZXYLP65.js";
import "./chunk-FYV5QAZU.js";
import "./chunk-NZOTMLR5.js";
import {
  Container,
  Point,
  Rectangle,
...
(function(l, t) {
  (function() {
    var e, n;
    n = /* @__PURE__ */ __name(function(i) {
      return l.exports = i;
    }, "n"), e = {
      linear: /* @__PURE__ */ __name(function(i, s, h, o) {
        return h * i / o + s;
      }, "linear"),
      easeInQuad: /* @__PURE__ */ __name(function(i, s, h, o) {
        return h * (i /= o) * i + s;
      }, "easeInQuad"),
      easeOutQuad: /* @__PURE__ */ __name(function(i, s, h, o) {
        return -h * (i /= o) * (i - 2) + s;
      }, "easeOutQuad"),
      easeInOutQuad: /* @__PURE__ */ __name(function(i, s, h, o) {
        return (i /= o / 2) < 1 ? h / 2 * i * i + s : -h / 2 * (--i * (i - 2) - 1) + s;
      }, "easeInOutQuad"),
      easeInCubic: /* @__PURE__ */ __name(function(i, s, h, o) {
        return h * (i /= o) * i * i + s;
      }, "easeInCubic"),
      easeOutCubic: /* @__PURE__ */ __name(function(i, s, h, o) {
        return h * ((i = i / o - 1) * i * i + 1) + s;
      }, "easeOutCubic"),
      easeInOutCubic: /* @__PURE__ */ __name(function(i, s, h, o) {
        return (i /= o / 2) < 1 ? h / 2 * i * i * i + s : h / 2 * ((i -= 2) * i * i + 2) + s;
      }, "easeInOutCubic"),
      easeInQuart: /* @__PURE__ */ __name(function(i, s, h, o) {
        return h * (i /= o) * i * i * i + s;
      }, "easeInQuart"),
      easeOutQuart: /* @__PURE__ */ __name(function(i, s, h, o) {
        return -h * ((i = i / o - 1) * i * i * i - 1) + s;
      }, "easeOutQuart"),
      easeInOutQuart: /* @__PURE__ */ __name(function(i, s, h, o) {
        return (i /= o / 2) < 1 ? h / 2 * i * i * i * i + s : -h / 2 * ((i -= 2) * i * i * i - 2) + s;
      }, "easeInOutQuart"),
      easeInQuint: /* @__PURE__ */ __name(function(i, s, h, o) {
        return h * (i /= o) * i * i * i * i + s;
      }, "easeInQuint"),
      easeOutQuint: /* @__PURE__ */ __name(function(i, s, h, o) {
        return h * ((i = i / o - 1) * i * i * i * i + 1) + s;
      }, "easeOutQuint"),
      easeInOutQuint: /* @__PURE__ */ __name(function(i, s, h, o) {
        return (i /= o / 2) < 1 ? h / 2 * i * i * i * i * i + s : h / 2 * ((i -= 2) * i * i * i * i + 2) + s;
      }, "easeInOutQuint"),
      easeInSine: /* @__PURE__ */ __name(function(i, s, h, o) {
        return -h * Math.cos(i / o * (Math.PI / 2)) + h + s;
      }, "easeInSine"),
      easeOutSine: /* @__PURE__ */ __name(function(i, s, h, o) {
        return h * Math.sin(i / o * (Math.PI / 2)) + s;
      }, "easeOutSine"),
      easeInOutSine: /* @__PURE__ */ __name(function(i, s, h, o) {
        return -h / 2 * (Math.cos(Math.PI * i / o) - 1) + s;
      }, "easeInOutSine"),
      easeInExpo: /* @__PURE__ */ __name(function(i, s, h, o) {
        return i === 0 ? s : h * Math.pow(2, 10 * (i / o - 1)) + s;
      }, "easeInExpo"),
      easeOutExpo: /* @__PURE__ */ __name(function(i, s, h, o) {
        return i === o ? s + h : h * (-Math.pow(2, -10 * i / o) + 1) + s;
      }, "easeOutExpo"),
      easeInOutExpo: /* @__PURE__ */ __name(function(i, s, h, o) {
        return (i /= o / 2) < 1 ? h / 2 * Math.pow(2, 10 * (i - 1)) + s : h / 2 * (-Math.pow(2, -10 * --i) + 2) + s;
      }, "easeInOutExpo"),
      easeInCirc: /* @__PURE__ */ __name(function(i, s, h, o) {
        return -h * (Math.sqrt(1 - (i /= o) * i) - 1) + s;
      }, "easeInCirc"),
      easeOutCirc: /* @__PURE__ */ __name(function(i, s, h, o) {
        return h * Math.sqrt(1 - (i = i / o - 1) * i) + s;
      }, "easeOutCirc"),
      easeInOutCirc: /* @__PURE__ */ __name(function(i, s, h, o) {
        return (i /= o / 2) < 1 ? -h / 2 * (Math.sqrt(1 - i * i) - 1) + s : h / 2 * (Math.sqrt(1 - (i -= 2) * i) + 1) + s;
      }, "easeInOutCirc"),
      easeInElastic: /* @__PURE__ */ __name(function(i, s, h, o) {
        var r, a, p;
      ...
      easeOutElastic: /* @__PURE__ */ __name(function(i, s, h, o) {
        var r, a, p;
      ...
      easeInOutElastic: /* @__PURE__ */ __name(function(i, s, h, o) {
        var r, a, p;
      ...
      easeInBack: /* @__PURE__ */ __name(function(i, s, h, o, r) {
        return r === void 0 && (r = 1.70158), h * (i /= o) * i * ((r + 1) * i - r) + s;
      }, "easeInBack"),
      easeOutBack: /* @__PURE__ */ __name(function(i, s, h, o, r) {
        return r === void 0 && (r = 1.70158), h * ((i = i / o - 1) * i * ((r + 1) * i + r) + 1) + s;
      }, "easeOutBack"),
      easeInOutBack: /* @__PURE__ */ __name(function(i, s, h, o, r) {
        return r === void 0 && (r = 1.70158), (i /= o / 2) < 1 ? h / 2 * (i * i * (((r *= 1.525) + 1) * i - r)) + s : h / 2 * ((i -= 2) * i * (((r *= 1.525) + 1) * i + r) + 2) + s;
      }, "easeInOutBack"),
      easeInBounce: /* @__PURE__ */ __name(function(i, s, h, o) {
        var r;
        return r = e.easeOutBounce(o - i, 0, h, o), h - r + s;
      }, "easeInBounce"),
      easeOutBounce: /* @__PURE__ */ __name(function(i, s, h, o) {
      ...
      easeInOutBounce: /* @__PURE__ */ __name(function(i, s, h, o) {
        var r;
...
var _U = class _U extends u {
  ...
  */
  handleKeyPresses(t) {
    const e = /* @__PURE__ */ __name((i) => {
      t.includes(i.code) && (this.keyIsPressed = true);
    }, "e"), n = /* @__PURE__ */ __name((i) => {
...
var _it = class _it extends Container {
  /**
