...
var _CanvasObserver = class _CanvasObserver {
  constructor(options) {
    this._lastTransform = "";
    this._observer = null;
...
__name(_CanvasObserver, "CanvasObserver");
var CanvasObserver = _CanvasObserver;

// node_modules/pixi.js/lib/events/FederatedEvent.mjs
var _FederatedEvent = class _FederatedEvent {
  /**
...
__name(_FederatedEvent, "FederatedEvent");
var FederatedEvent = _FederatedEvent;
...
var _a;
var _AccessibilitySystem = (_a = class {
   ...
   */
  init(options) {
    const defaultOpts = _a.defaultOptions;
    const mergedOptions = {
...
}, __name(_a, "_AccessibilitySystem"), _a);
...
var _EventsTickerClass = class _EventsTickerClass {
  constructor() {
...
__name(_EventsTickerClass, "EventsTickerClass");
var EventsTickerClass = _EventsTickerClass;
var EventsTicker = new EventsTickerClass();

// node_modules/pixi.js/lib/events/FederatedMouseEvent.mjs
var _FederatedMouseEvent = class _FederatedMouseEvent extends FederatedEvent {
  constructor() {
    super(...arguments);
...
__name(_FederatedMouseEvent, "FederatedMouseEvent");
var FederatedMouseEvent = _FederatedMouseEvent;

// node_modules/pixi.js/lib/events/FederatedPointerEvent.mjs
var _FederatedPointerEvent = class _FederatedPointerEvent extends FederatedMouseEvent {
  constructor() {
    super(...arguments);
    this.width = 0;
    this.height = 0;
...
__name(_FederatedPointerEvent, "FederatedPointerEvent");
var FederatedPointerEvent = _FederatedPointerEvent;

// node_modules/pixi.js/lib/events/FederatedWheelEvent.mjs
var _FederatedWheelEvent = class _FederatedWheelEvent extends FederatedMouseEvent {
  constructor() {
    super(...arguments);
...
__name(_FederatedWheelEvent, "FederatedWheelEvent");
var FederatedWheelEvent = _FederatedWheelEvent;
...
var _EventBoundary = class _EventBoundary {
  /**
...
__name(_EventBoundary, "EventBoundary");
var EventBoundary = _EventBoundary;
...
var _EventSystem = (_a2 = class {
  ...
  constructor(renderer) {
    ...
    this.features = new Proxy({ ..._a2.defaultEventFeatures }, {
  ...
  init(options) {
    ...
    _a2._defaultEventMode = options.eventMode ?? "passive";
...
__name(_DOMPipe, "DOMPipe");
var DOMPipe = _DOMPipe;
DOMPipe.extension = {
  type: [
...
var _DOMContainer = class _DOMContainer extends ViewContainer {
  /**
...
__name(_DOMContainer, "DOMContainer");
var DOMContainer = _DOMContainer;
...
//# sourceMappingURL=chunk-SIVKA2UL.js.map
