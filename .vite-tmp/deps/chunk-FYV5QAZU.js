...
var _GlGraphicsAdaptor = class _GlGraphicsAdaptor {
...
__name(_GlGraphicsAdaptor, "GlGraphicsAdaptor");
var GlGraphicsAdaptor = _GlGraphicsAdaptor;
...
var _GlMeshAdaptor = class _GlMeshAdaptor {
  init() {
    const glProgram = compileHighShaderGlProgram({
      name: "mesh",
      bits: [
...
__name(_GlMeshAdaptor, "GlMeshAdaptor");
var GlMeshAdaptor = _GlMeshAdaptor;
...
var _GlBatchAdaptor = class _GlBatchAdaptor {
  constructor() {
...
__name(_GlBatchAdaptor, "GlBatchAdaptor");
var GlBatchAdaptor = _GlBatchAdaptor;
...
__name(_GlBufferSystem, "GlBufferSystem");
var GlBufferSystem = _GlBufferSystem;
...
var _GlGeometrySystem = class _GlGeometrySystem {
  /** @param renderer - The renderer this System works for. */
  constructor(renderer) {
...
__name(_GlGeometrySystem, "GlGeometrySystem");
var GlGeometrySystem = _GlGeometrySystem;
...
var _a2;
var _GlBackBufferSystem = (_a2 = class {
  constructor(renderer) {
  ...
  init(options = {}) {
    const { useBackBuffer, antialias } = { ..._a2.defaultOptions, ...options };
...
}, __name(_a2, "_GlBackBufferSystem"), _a2);
...
var _GlColorMaskSystem = class _GlColorMaskSystem {
  constructor(renderer) {
...
__name(_GlColorMaskSystem, "GlColorMaskSystem");
var GlColorMaskSystem = _GlColorMaskSystem;
...
var _GlEncoderSystem = class _GlEncoderSystem {
  constructor(renderer) {
...
__name(_GlEncoderSystem, "GlEncoderSystem");
var GlEncoderSystem = _GlEncoderSystem;
...
var _GlLimitsSystem = class _GlLimitsSystem {
  constructor(renderer) {
    this._renderer = renderer;
  }
  contextChange() {
...
__name(_GlLimitsSystem, "GlLimitsSystem");
var GlLimitsSystem = _GlLimitsSystem;
...
var _GlStencilSystem = class _GlStencilSystem {
  constructor(renderer) {
    this._stencilCache = {
      enabled: false,
      stencilReference: 0,
...
__name(_GlStencilSystem, "GlStencilSystem");
var GlStencilSystem = _GlStencilSystem;
...
var _GlUboSystem = class _GlUboSystem extends UboSystem {
  constructor() {
    super({
...
__name(_GlUboSystem, "GlUboSystem");
var GlUboSystem = _GlUboSystem;
...
var _GlRenderTarget = class _GlRenderTarget {
  constructor() {
    this.width = -1;
    this.height = -1;
    this.msaa = false;
...
__name(_GlRenderTarget, "GlRenderTarget");
var GlRenderTarget = _GlRenderTarget;

// node_modules/pixi.js/lib/rendering/renderers/gl/renderTarget/GlRenderTargetAdaptor.mjs
var _GlRenderTargetAdaptor = class _GlRenderTargetAdaptor {
  constructor() {
...
__name(_GlRenderTargetAdaptor, "GlRenderTargetAdaptor");
var GlRenderTargetAdaptor = _GlRenderTargetAdaptor;

// node_modules/pixi.js/lib/rendering/renderers/gl/renderTarget/GlRenderTargetSystem.mjs
var _GlRenderTargetSystem = class _GlRenderTargetSystem extends RenderTargetSystem {
  constructor(renderer) {
    super(renderer);
...
__name(_GlRenderTargetSystem, "GlRenderTargetSystem");
var GlRenderTargetSystem = _GlRenderTargetSystem;
...
var _IGLUniformData = class _IGLUniformData {
};
__name(_IGLUniformData, "IGLUniformData");
var IGLUniformData = _IGLUniformData;
var _GlProgramData = class _GlProgramData {
  /**
...
__name(_GlProgramData, "GlProgramData");
var GlProgramData = _GlProgramData;
...
var _GlShaderSystem = class _GlShaderSystem {
  constructor(renderer) {
...
__name(_GlShaderSystem, "GlShaderSystem");
var GlShaderSystem = _GlShaderSystem;
...
var _GlUniformGroupSystem = class _GlUniformGroupSystem {
  /** @param renderer - The renderer this System works for. */
  constructor(renderer) {
    this._cache = {};
...
__name(_GlUniformGroupSystem, "GlUniformGroupSystem");
var GlUniformGroupSystem = _GlUniformGroupSystem;
...
var _GlStateSystem = (_a3 = class {
   ...
   */
  setBlend(value) {
    this._updateCheck(_a3._checkBlendMode, value);
   ...
   */
  setOffset(value) {
    this._updateCheck(_a3._checkPolygonOffset, value);
...
var _GlTexture = class _GlTexture {
  constructor(texture) {
...
var _GlTextureSystem = class _GlTextureSystem {
  constructor(renderer) {
...
__name(_GlTextureSystem, "GlTextureSystem");
...
var _WebGLRenderer = class _WebGLRenderer extends AbstractRenderer {
  constructor() {
    const systemConfig = {
      name: "webgl",
...
//# sourceMappingURL=chunk-FYV5QAZU.js.map
