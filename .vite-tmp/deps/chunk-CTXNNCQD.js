...
var _GpuGraphicsAdaptor = class _GpuGraphicsAdaptor {
  constructor() {
    this._maxTextures = 0;
  }
...
__name(_GpuGraphicsAdaptor, "GpuGraphicsAdaptor");
var GpuGraphicsAdaptor = _GpuGraphicsAdaptor;
...
var _GpuMeshAdapter = class _GpuMeshAdapter {
  init() {
    const gpuProgram = compileHighShaderGpuProgram({
      name: "mesh",
      bits: [
...
__name(_GpuMeshAdapter, "GpuMeshAdapter");
var GpuMeshAdapter = _GpuMeshAdapter;
...
var _GpuBatchAdaptor = class _GpuBatchAdaptor {
...
__name(_GpuBatchAdaptor, "GpuBatchAdaptor");
var GpuBatchAdaptor = _GpuBatchAdaptor;
...
var _BindGroupSystem = class _BindGroupSystem {
...
__name(_BindGroupSystem, "BindGroupSystem");
var BindGroupSystem = _BindGroupSystem;
...
var _GpuBufferSystem = class _GpuBufferSystem {
  constructor(renderer) {
...
__name(_GpuBufferSystem, "GpuBufferSystem");
var GpuBufferSystem = _GpuBufferSystem;
...
var _GpuColorMaskSystem = class _GpuColorMaskSystem {
  constructor(renderer) {
...
__name(_GpuColorMaskSystem, "GpuColorMaskSystem");
var GpuColorMaskSystem = _GpuColorMaskSystem;
...
var _GpuDeviceSystem = class _GpuDeviceSystem {
  /**
...
__name(_GpuDeviceSystem, "GpuDeviceSystem");
var GpuDeviceSystem = _GpuDeviceSystem;
...
var _GpuEncoderSystem = class _GpuEncoderSystem {
  constructor(renderer) {
...
__name(_GpuEncoderSystem, "GpuEncoderSystem");
var GpuEncoderSystem = _GpuEncoderSystem;
...
var _GpuLimitsSystem = class _GpuLimitsSystem {
  constructor(renderer) {
    this._renderer = renderer;
  }
  contextChange() {
...
__name(_GpuLimitsSystem, "GpuLimitsSystem");
var GpuLimitsSystem = _GpuLimitsSystem;
...
var _GpuStencilSystem = class _GpuStencilSystem {
  constructor(renderer) {
...
__name(_GpuStencilSystem, "GpuStencilSystem");
var GpuStencilSystem = _GpuStencilSystem;
...
var _GpuUboSystem = class _GpuUboSystem extends UboSystem {
  constructor() {
    super({
...
__name(_GpuUboSystem, "GpuUboSystem");
var GpuUboSystem = _GpuUboSystem;
...
__name(_GpuUniformBatchPipe, "GpuUniformBatchPipe");
var GpuUniformBatchPipe = _GpuUniformBatchPipe;
...
var _PipelineSystem = class _PipelineSystem {
  constructor(renderer) {
...
__name(_PipelineSystem, "PipelineSystem");
var PipelineSystem = _PipelineSystem;
...
var _GpuRenderTarget = class _GpuRenderTarget {
  constructor() {
    this.contexts = [];
    this.msaaTextures = [];
    this.msaaSamples = 1;
...
__name(_GpuRenderTarget, "GpuRenderTarget");
var GpuRenderTarget = _GpuRenderTarget;

// node_modules/pixi.js/lib/rendering/renderers/gpu/renderTarget/GpuRenderTargetAdaptor.mjs
var _GpuRenderTargetAdaptor = class _GpuRenderTargetAdaptor {
...
__name(_GpuRenderTargetAdaptor, "GpuRenderTargetAdaptor");
var GpuRenderTargetAdaptor = _GpuRenderTargetAdaptor;

// node_modules/pixi.js/lib/rendering/renderers/gpu/renderTarget/GpuRenderTargetSystem.mjs
var _GpuRenderTargetSystem = class _GpuRenderTargetSystem extends RenderTargetSystem {
  constructor(renderer) {
    super(renderer);
...
__name(_GpuRenderTargetSystem, "GpuRenderTargetSystem");
var GpuRenderTargetSystem = _GpuRenderTargetSystem;
...
var _GpuShaderSystem = class _GpuShaderSystem {
  constructor() {
...
__name(_GpuShaderSystem, "GpuShaderSystem");
var GpuShaderSystem = _GpuShaderSystem;
...
var _GpuStateSystem = class _GpuStateSystem {
  constructor() {
...
__name(_GpuStateSystem, "GpuStateSystem");
var GpuStateSystem = _GpuStateSystem;
...
var _GpuMipmapGenerator = class _GpuMipmapGenerator {
  constructor(device) {
    this.device = device;
...
__name(_GpuMipmapGenerator, "GpuMipmapGenerator");
var GpuMipmapGenerator = _GpuMipmapGenerator;

// node_modules/pixi.js/lib/rendering/renderers/gpu/texture/GpuTextureSystem.mjs
var _GpuTextureSystem = class _GpuTextureSystem {
  constructor(renderer) {
...
__name(_GpuTextureSystem, "GpuTextureSystem");
...
var _WebGPURenderer = class _WebGPURenderer extends AbstractRenderer {
  constructor() {
    const systemConfig = {
      name: "webgpu",
...
__name(_WebGPURenderer, "WebGPURenderer");
var WebGPURenderer = _WebGPURenderer;
...
//# sourceMappingURL=chunk-CTXNNCQD.js.map
