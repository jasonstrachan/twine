...
var _a;
var _Filter = (_a = class extends Shader {
  /**
   * @param options - The optional parameters of this filter.
   */
  constructor(options) {
    options = { ..._a.defaultOptions, ...options };
    super(options);
    this.enabled = true;
...
var _SystemRunner = class _SystemRunner {
  /**
...
__name(_SystemRunner, "SystemRunner");
var SystemRunner = _SystemRunner;
...
var _a2;
var _AbstractRenderer = (_a2 = class extends eventemitter3_default {
  /**
...
}, __name(_a2, "_AbstractRenderer"), _a2);
...
var _CustomRenderPipe = class _CustomRenderPipe {
...
__name(_CustomRenderPipe, "CustomRenderPipe");
var CustomRenderPipe = _CustomRenderPipe;
...
var _RenderGroupPipe = class _RenderGroupPipe {
  constructor(renderer) {
    this._renderer = renderer;
  }
...
__name(_RenderGroupPipe, "RenderGroupPipe");
var RenderGroupPipe = _RenderGroupPipe;
...
var _RenderGroupSystem = class _RenderGroupSystem {
  constructor(renderer) {
    this._renderer = renderer;
  }
...
__name(_RenderGroupSystem, "RenderGroupSystem");
var RenderGroupSystem = _RenderGroupSystem;
...
var _SpritePipe = class _SpritePipe {
  constructor(renderer) {
    this._renderer = renderer;
  }
...
__name(_SpritePipe, "SpritePipe");
var SpritePipe = _SpritePipe;
...
var _ApplicationInitHook = class _ApplicationInitHook {
  static init() {
...
__name(_ApplicationInitHook, "ApplicationInitHook");
var ApplicationInitHook = _ApplicationInitHook;
ApplicationInitHook.extension = ExtensionType.Application;
var _RendererInitHook = class _RendererInitHook {
  constructor(renderer) {
    this._renderer = renderer;
  }
  init() {
...
__name(_RendererInitHook, "RendererInitHook");
var RendererInitHook = _RendererInitHook;
...
var _BatcherPipe = (_a3 = class {
  ...
  addToBatch(batchableObject, instructionSet) {
    if (this._activeBatch.name !== batchableObject.batcherName) {
      ...
      if (!batch) {
        batch = this._activeBatches[batchableObject.batcherName] = _a3.getBatcher(batchableObject.batcherName);
        batch.begin();
      }
...
var _MaskFilter = class _MaskFilter extends Filter {
  constructor(options) {
...
__name(_MaskFilter, "MaskFilter");
var MaskFilter = _MaskFilter;

// node_modules/pixi.js/lib/rendering/mask/alpha/AlphaMaskPipe.mjs
var tempBounds = new Bounds();
var _AlphaMaskEffect = class _AlphaMaskEffect extends FilterEffect {
  constructor() {
    super();
...
__name(_AlphaMaskEffect, "AlphaMaskEffect");
var AlphaMaskEffect = _AlphaMaskEffect;
var _AlphaMaskPipe = class _AlphaMaskPipe {
  constructor(renderer) {
...
__name(_AlphaMaskPipe, "AlphaMaskPipe");
var AlphaMaskPipe = _AlphaMaskPipe;
...
var _ColorMaskPipe = class _ColorMaskPipe {
  constructor(renderer) {
    this._colorStack = [];
...
__name(_ColorMaskPipe, "ColorMaskPipe");
var ColorMaskPipe = _ColorMaskPipe;
...
var _StencilMaskPipe = class _StencilMaskPipe {
  constructor(renderer) {
    this._maskStackHash = {};
  ...
  push(mask, _container, instructionSet) {
    ...
    (_a10 = this._maskStackHash)[renderTargetUid] ?? (_a10[renderTargetUid] = 0);
  }
  ...
  execute(instruction) {
    ...
    const renderer = this._renderer;
    const renderTargetUid = renderer.renderTarget.renderTarget.uid;
    let maskStackIndex = (_a10 = this._maskStackHash)[renderTargetUid] ?? (_a10[renderTargetUid] = 0);
    if (instruction.action === "pushMaskBegin") {
...
__name(_StencilMaskPipe, "StencilMaskPipe");
var StencilMaskPipe = _StencilMaskPipe;
...
var _a4;
var _BackgroundSystem = (_a4 = class {
  constructor() {
...
}, __name(_a4, "_BackgroundSystem"), _a4);
...
var _BlendModePipe = class _BlendModePipe {
  constructor(renderer) {
...
__name(_BlendModePipe, "BlendModePipe");
var BlendModePipe = _BlendModePipe;
...
var noColor = [0, 0, 0, 0];
var _GenerateTextureSystem = class _GenerateTextureSystem {
  constructor(renderer) {
    this._renderer = renderer;
  }
  /**
...
__name(_GenerateTextureSystem, "GenerateTextureSystem");
var GenerateTextureSystem = _GenerateTextureSystem;
...
var _GlobalUniformSystem = class _GlobalUniformSystem {
  constructor(renderer) {
    this._stackIndex = 0;
...
__name(_GlobalUniformSystem, "GlobalUniformSystem");
var GlobalUniformSystem = _GlobalUniformSystem;
...
var uid2 = 1;
var _SchedulerSystem = class _SchedulerSystem {
  constructor() {
    this._tasks = [];
    this._offset = 0;
  }
...
__name(_SchedulerSystem, "SchedulerSystem");
var SchedulerSystem = _SchedulerSystem;
...
var _HelloSystem = class _HelloSystem {
  constructor(renderer) {
    this._renderer = renderer;
  }
  /**
...
__name(_HelloSystem, "HelloSystem");
var HelloSystem = _HelloSystem;
...
var _a6;
var _RenderableGCSystem = (_a6 = class {
  /**
...
}, __name(_a6, "_RenderableGCSystem"), _a6);
...
var _a7;
var _TextureGCSystem = (_a7 = class {
  /** @param renderer - The renderer this System works for. */
  constructor(renderer) {
    this._renderer = renderer;
    this.count = 0;
...
}, __name(_a7, "_TextureGCSystem"), _a7);
...
var _RenderTarget = (_a8 = class {
  ...
  constructor(descriptor = {}) {
    ...
    descriptor = { ..._a8.defaultOptions, ...descriptor };
...
var _UboSystem = class _UboSystem {
  constructor(adaptor) {
...
__name(_UboSystem, "UboSystem");
var UboSystem = _UboSystem;
...
var uniformParsers = [
  ...
  {
    type: "vec4<f32>",
    test: /* @__PURE__ */ __name((data) => data.type === "vec4<f32>" && data.size === 1 && data.value.width !== void 0, "test"),
    ubo: `
            v = uv[name];
            data[offset] = v.x;
            data[offset + 1] = v.y;
  ...
  {
    type: "vec2<f32>",
    test: /* @__PURE__ */ __name((data) => data.type === "vec2<f32>" && data.size === 1 && data.value.x !== void 0, "test"),
    ubo: `
            v = uv[name];
            data[offset] = v.x;
            data[offset + 1] = v.y;
  ...
  {
    type: "vec4<f32>",
    test: /* @__PURE__ */ __name((data) => data.type === "vec4<f32>" && data.size === 1 && data.value.red !== void 0, "test"),
    ubo: `
            v = uv[name];
            data[offset] = v.red;
  ...
  {
    type: "vec3<f32>",
    test: /* @__PURE__ */ __name((data) => data.type === "vec3<f32>" && data.size === 1 && data.value.red !== void 0, "test"),
    ubo: `
            v = uv[name];
            data[offset] = v.red;
            data[offset + 1] = v.green;
...
var _BufferResource = class _BufferResource extends eventemitter3_default {
  /**
...
__name(_BufferResource, "BufferResource");
var BufferResource = _BufferResource;
...
var _RenderTargetSystem = class _RenderTargetSystem {
  constructor(renderer) {
...
__name(_RenderTargetSystem, "RenderTargetSystem");
var RenderTargetSystem = _RenderTargetSystem;
...
//# sourceMappingURL=chunk-NZOTMLR5.js.map
